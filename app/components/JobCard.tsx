...
export default function JobCard({ job, onApply, isApplying }: JobCardProps) {
  ...
  return (
    <div className="group relative flex flex-col gap-4 rounded-xl border border-slate-200 bg-gray-100 p-5 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-md">
      {/* Header */}
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-start gap-3 min-w-0">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-indigo-200 text-sm font-semibold text-indigo-700 ring-1 ring-inset ring-indigo-100">
            {companyInitial}
          </div>
      ...
      {job.status === "FAILED" && job.failureReason && (
        <div className="flex items-start gap-2 rounded-lg border border-red-100 bg-red-100 px-3 py-2">
          <svg
      ...
      <div className="mt-1 flex flex-wrap items-center gap-2 border-t border-slate-100 pt-4">
        <a
          ...
          className="inline-flex items-center gap-1.5 rounded-lg border border-slate-400 px-3 py-1.5 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-1"
        >
          View job
          <svg
      ...
      {showScreenshot && (
        ...
        >
          ...
          >
            ...
            {/* Image area */}
            <div className="relative flex min-h-75 flex-1 items-center justify-center overflow-auto bg-slate-100">
              {imageStatus === "loading" && (
